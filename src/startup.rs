...
impl Application {
    // We converted the `build` function into a constructor for
    // `Application`
    ...
    // A more expressive name that makes clear that
...
// We define a wrapper type in order to retrieve the URL
